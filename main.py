...
SEC_KEY = 'zD97aP2w1jhsjId32XbhyJj0YBeYMJGzlSjAcKeA'
PUB_KEY = 'PKJSXHRGARUQ4L52AXNO'
...
market_data = api.get_barset(symb, 'hours', limit=(60 * hours_to_test)) # Pull market data from the past 60x minutes
...
startBal = 20000 # Start out with 2000 dollars
balance = startBal
buys = 0
sells = 0
...
#print start ballance 
print("Start balance: "+str(startBal))
